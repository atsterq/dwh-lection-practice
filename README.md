...
Задание R6.1  
В рамках таблицы payments в GreenPlum, скопированной в вашу схему реализуйте транзакцию, 
которая добавляет записи в нее, а также обновляет уже существующие записи. Одна из операций 
обновления должна быть неуспешной.   
Формат ответа: SQL-скрипты в текстовом документе и изменения в таблицах.   
## Реализация  
![alt text](image.png)  
- [sql script](<sql scripts/practice_6.sql>)